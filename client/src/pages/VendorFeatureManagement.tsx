...
const ALL_FEATURES = [
  ...
  { key: 'customTemplates', name: 'Template Management', category: 'Core Features' },
  { key: 'multiUser', name: 'Account Management', category: 'Core Features' },
  { key: 'tagManagement', name: 'Tag Management', category: 'Core Features' },
